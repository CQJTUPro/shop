...
<body>
	<form id="userAction_save_do" enctype="multipart/form-data" name="Form1"
		action="${pageContext.request.contextPath}/adminProduct_editProduct.action" method="post">
		...
		<table cellSpacing="1" cellPadding="5" width="100%" align="center" bgColor="#eeeeee"
			...
			<tr>
				<td class="ta_01" align="center" bgColor="#afd1f3" colSpan="4" height="26"><strong><STRONG>编辑商品</STRONG>
				</strong></td>
			</tr>

			<tr>
				<td width="18%" align="center" bgColor="#f5fafe" class="ta_01">商品名称：</td>
				<td class="ta_01" bgColor="#ffffff"><input type="text" name="pname"
					value="<s:property value="model.pname"/>" id="userAction_save_do_logonName"
			...
			<tr>
				...
				<td class="ta_01" bgColor="#ffffff"><input type="text" name="market_price"
					value="<s:property value="model.market_price"/>" id="userAction_save_do_logonName"
					class="form-control" /></td>
				<td width="18%" align="center" bgColor="#f5fafe" class="ta_01">商品商城价格：</td>
				<td class="ta_01" bgColor="#ffffff"><input type="text" name="shop_price"
					value="<s:property value="model.shop_price"/>" id="userAction_save_do_logonName"
					class="form-control" /></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td class="ta_01" bgColor="#ffffff"><input name="upload" type="file" value="" /></td>
			</tr>
			<tr>
				...
				<td class="ta_01" bgColor="#ffffff"><textarea rows="5" cols="30" name="pdesc"
						class="form-control"><s:property value="model.pdesc" /></textarea></td>
			</tr>
			<tr>
