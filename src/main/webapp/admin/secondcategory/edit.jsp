...
<body>
	<form id="userAction_save_do" name="Form1"
		action="${pageContext.request.contextPath}/adminCategory_editSecond.action" method="post">
		...
		<table cellSpacing="1" cellPadding="5" width="100%" align="center" bgColor="#eeeeee"
			...
			<tr>
				<td class="ta_01" align="center" bgColor="#afd1f3" colSpan="4" height="26"><strong><STRONG>编辑二级分类</STRONG>
				</strong></td>
			</tr>

			<tr>
				<td width="18%" align="center" bgColor="#f5fafe" class="ta_01">二级分类名称：</td>
				<td class="ta_01" bgColor="#ffffff"><input type="text" name="cname"
				...
				<td class="ta_01" bgColor="#ffffff"><select name="parentid" class="form-control">
						<s:iterator value="clist" var="c">
							<option value="<s:property value="#c.cid"/>"
								<s:if test="model.parentid==#c.cid">selected</s:if>><s:property value="#c.cname" /></option>
