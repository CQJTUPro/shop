...
<script type="text/javascript">
			function addCategory(){
				window.location.href = "${pageContext.request.contextPath}/adminCategory_addSecondPage.action";
			}
		</script>
</HEAD>
<body>
	...
	<form id="Form1" name="Form1" action="${pageContext.request.contextPath}/user/list.jsp"
		...
		<table cellSpacing="1" cellPadding="0" width="100%" align="center" bgColor="#7f8fa6" border="0"
			...
			<TBODY>
				<tr>
					<td class="ta_01" align="center" bgColor="#dcdde1"><strong>二级分类列表</strong></TD>
				</tr>
				<tr>
							...
							<s:iterator var="c" value="pageBean.list" status="status">
								<tr onmouseover="this.style.backgroundColor = 'white'"
									...
									<td align="center" style="HEIGHT: 22px"><a
										href="${pageContext.request.contextPath}/adminCategory_editSecondPage.action?cid=<s:property value="#c.cid"/>">
											<img src="${pageContext.request.contextPath}/images/i_edit.gif" border="0"
											style="CURSOR: hand">
									</a></td>

									<td align="center" style="HEIGHT: 22px"><a
										href="${pageContext.request.contextPath}/adminCategory_removeSecond.action?cid=<s:property value="#c.cid"/>">
