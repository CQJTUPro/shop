...
<body>
	...
	<div class="container login">
		<div class="span12">
			<div class="ad">
				<img src="${pageContext.request.contextPath}/image/login.jpg" width="500" height="330"
					alt="会员登录" title="会员登录">
			</div>
		</div>
					...
					<form id="loginForm" action="${pageContext.request.contextPath}/user_login.action"
						...
						<table>
							<tbody>
								...
								<tr>
									<th>&nbsp;</th>
									<td><label> <input type="checkbox" id="isRemember" name="autoLogin"
											value="autoLogin">7天内免登录 </label></td>
								</tr>
								<tr>
									<th>&nbsp;</th>
									<td style="color: red;"><s:property value="#request.info" /></td>
								</tr>
								<tr>
									<th>&nbsp;</th>
