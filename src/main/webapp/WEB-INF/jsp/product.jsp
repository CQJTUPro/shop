...
<body>
	...
	$(function(){
		...
		<div class="span18 last">
			...
			<form id="cartForm" action="${pageContext.request.contextPath}/cart_addCartItem.action"
				method="post">
				...
				<div class="action">
					...
					<div class="buy">
						<input id="addCartItem" class="addCart" value="加入购物车" type="button" onclick="addCart()">
					</div>
				</div>
			</form>
